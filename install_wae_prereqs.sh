...
export JRE_HOME=/usr/lib/jvm/java-11-openjdk-11.0.11.0.9-2.el8_4.x86_64
sudo echo "export JAVA_HOME=/usr/lib/jvm/java-11-openjdk-11.0.11.0.9-2.el8_4.x86_64/bin/java" >> .bash_profile
sudo echo "export JRE_HOME=/usr/lib/jvm/java-11-openjdk-11.0.11.0.9-2.el8_4" >> .bash_profile
env | grep java
java -version
